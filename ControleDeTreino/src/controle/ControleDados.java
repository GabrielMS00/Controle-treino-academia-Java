...
public class ControleDados {
	...
	public boolean inserirEditarUsuario(String[] dadosUsuarios) {
		...
		Usuario u = new Usuario(dadosUsuarios[1], Integer.parseInt(dadosUsuarios[2]), Integer.parseInt(dadosUsuarios[3]), Float.parseFloat(dadosUsuarios[4]), dadosUsuarios[5],
	...
	public boolean inserirEditarPersonal(String[] dadosPersonais) {
		...
		Personal p = new Personal(dadosPersonais[1], Integer.parseInt(dadosPersonais[2]), 
								Integer.parseInt(dadosPersonais[3]), dadosPersonais[4]);
