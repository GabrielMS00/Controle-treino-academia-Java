...
public class TelaDetalhePessoa implements ActionListener {
	...
	public void inserirEditar(int op, ControleDados d, 
		...
		valorCpf.setBounds(180, 20, 180, 25);
		
		labelCep.setBounds(30, 20, 150, 25);
		valorCep.setBounds(180, 20, 180, 25);
		
		labelPeso.setBounds(30, 20, 150, 25);
		valorPeso.setBounds(180, 20, 180, 25);
		
		labelAltura.setBounds(30, 20, 150, 25);
		valorAltura.setBounds(180, 20, 180, 25);
		
		labelFrequenciaSemana.setBounds(30, 20, 150, 25);
		valorFrequenciaSemana.setBounds(180, 20, 180, 25);
		
		labelIdade.setBounds(30, 20, 150, 25);
		valorIdade.setBounds(180, 20, 180, 25);
		
		labelAcademia.setBounds(30, 20, 150, 25);
		valorAcademia.setBounds(180, 20, 180, 25);
		
		labelDisponibilidade.setBounds(30, 20, 150, 25);
		valorDisponibilidade.setBounds(180, 20, 180, 25);
